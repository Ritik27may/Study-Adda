          ...
          <div className="max-w-[500px] p-4 lg:p-8">
              ...
              <form onSubmit={handleOnSubmit}>
                ...
                <label className = "relative">
                    ...
                    <span  onClick={() => setShowPassword((prev) => !prev)} className="absolute right-3 top-[30px] z-[10] cursor-pointer"  >         
                ...
                <label className="relative mt-3 block">
                    ...
                    <span onClick={() => setShowConfirmPassword((prev) => !prev)}  className="absolute right-3 top-[30px] z-[10] cursor-pointer" >            
